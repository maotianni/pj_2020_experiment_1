...
class TGN(torch.nn.Module):
    ...
    def get_raw_messages(self, source_nodes, source_node_embedding, destination_nodes,
        ...
        destination_memory = self.memory.get_memory(destination_nodes) if not \
            self.use_destination_embedding_in_message else destination_node_embedding
