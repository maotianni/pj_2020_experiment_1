...
###################################################################################################
# 电影评分
def eval_score_prediction(tgn, decoder, data, edge_idxs, batch_size, possible_score, n_neighbors):
  ...
  with torch.no_grad():
    ...
    for k in range(num_batch):
      ...
      source_embedding, destination_embedding, _ = tgn.compute_temporal_embeddings(sources_batch,
                                                                                   ...
                                                                                   edge_idxs_batch,
                                                                                   n_neighbors)
      pred_prob_batch = decoder(source_embedding, destination_embedding)
